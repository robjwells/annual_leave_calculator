...
This calculates how many days of annual leave
a new employee can take for the rest of the
year.

This assumes the annual leave year matches the
calendar year (Jan 1-Dec 31).

This works by taking the full leave allowance
for the year (as if the employee started on
January 1), and keeping a proportion of it
that matches the proportion of days left
in the year.

The proportion of the year that remains is worked
out by getting the year length (365 or 366) and
dividing the number of days left in the year by it.

The number of days left in the year is calculated
by taking the day of the year (strftime %j) and
subtracting it from the year length.
